...
<div className="relative h-52 overflow-hidden rounded-xl mb-6">
  ...
  <div className="absolute bottom-4 left-4 text-white text-lg font-bold">
    {service.title}
      ...
      {/* Content */}
      <h3 className="text-lg font-bold text-omnexa-black mb-3 tracking-tight">{service.title}</h3>
      <p className="text-sm text-omnexa-graphite leading-relaxed mb-6">{service.description}</p>
